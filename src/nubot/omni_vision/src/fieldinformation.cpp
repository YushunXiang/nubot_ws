...
FieldInformation::FieldInformation()
{
    ...
    oppGoal_[GOAL_MIDUPPER] = DPoint(xline_[0],50);
    oppGoal_[GOAL_MIDDLE]   = DPoint(xline_[0],0);
    oppGoal_[GOAL_MIDLOWER] = DPoint(xline_[0],-50);
    oppGoal_[GOAL_LOWER]    = DPoint(xline_[0],-120);

    ourGoal_[GOAL_UPPER]    = DPoint(xline_[6],120);
    ourGoal_[GOAL_MIDUPPER] = DPoint(xline_[6],50);
    ourGoal_[GOAL_MIDDLE]   = DPoint(xline_[6],0);
    ourGoal_[GOAL_MIDLOWER] = DPoint(xline_[6],-50);
