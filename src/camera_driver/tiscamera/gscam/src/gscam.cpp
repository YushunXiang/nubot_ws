...
#endif
      //!!!!!!!!!!!!!!!!!!!!!!!! modified by llh !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      //there is some problems with the function gst_caps_get_structure(), so I directly set the width_ and height_  to avoid buffer underflow.
      //I debugged and found that we can't get correct caps using the pad, this really confuse me.
      //Notice that the width_ and height_ can't be changed to another value.
      //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
